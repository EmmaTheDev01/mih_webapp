    ...
    <div className="bg-secondary text-white text-sm py-2">
      <div className="container mx-auto px-4 flex flex-col md:flex-row justify-between items-center">
        ...
        <div className="mb-2 md:mb-0">
          <span className="bg-primary px-2 py-1 rounded text-xs font-bold mr-2">NEW</span>
          <span>Join our upcoming tech workshop on May 15th! <a href="#" className="underline hover:text-gray-200">Learn more</a></span>
        </div>
        
        {/* Contact and Social Links */}
        <div className="flex items-center space-x-4">
          <a href="tel:+250780123456" className="hover:text-gray-200 flex items-center">
